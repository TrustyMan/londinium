...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"londinium", "preparecommunityproposal", &preparecommunityproposal, true, true, false},
        {"londinium", "submitcommunityproposal", &submitcommunityproposal, true, true, false},
        {"londinium", "getcommunityinfo", &getcommunityinfo, true, true, false},
        {"londinium", "checkcommunityproposals", &checkcommunityproposals, true, true, false},
        {"londinium", "getcommunityproposalvotes", &getcommunityproposalvotes, true, true, false},
        {"londinium", "mncommunityvote", &mncommunityvote, true, true, false},
#ifdef ENABLE_WALLET
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9512/\n";
}
