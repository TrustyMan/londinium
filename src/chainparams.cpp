...
public:
    CMainParams()
    {
        ...
        nTargetSpacing = 2 * 60;  // Londinium: 2 minutes
        nMaturity = 10;
        ...
        // DNS Seeding
        vSeeds.push_back(CDNSSeedData("142.93.60.168", "142.93.60.168"));           // Single node address
        vSeeds.push_back(CDNSSeedData("165.227.139.83", "165.227.139.83"));           // Single node address
        vSeeds.push_back(CDNSSeedData("159.65.101.207", "159.65.101.207"));           // Single node address
        vSeeds.push_back(CDNSSeedData("142.93.228.115", "142.93.228.115"));           // Single node address
        vSeeds.push_back(CDNSSeedData("159.65.107.243", "159.65.107.243"));           // Single node address
        vSeeds.push_back(CDNSSeedData("46.101.62.141", "46.101.62.141"));           // Single node address

        // Londinium addresses start with 'G'
