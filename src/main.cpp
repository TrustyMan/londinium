...
// Copyright (c) 2017-2017 The Londinium developers
...
int64_t GetBlockValue(int nHeight)
{
    ...
    } else if (nHeight < 113 && nHeight > 1) {
        nSubsidy = 0.1 * COIN;
    }
    else if (nHeight < Params().LAST_POW_BLOCK() && nHeight >= 113) {
        nSubsidy = 0.1 * COIN;
    }
    else if (nHeight < 24480 && nHeight >= Params().LAST_POW_BLOCK()) {
        nSubsidy = 0.3 * COIN;
    }
    else if (nHeight < 67680 && nHeight >=24480) {
        nSubsidy = 3 * COIN;
    }
    else if (nHeight < 110880 && nHeight >=67680) {
        nSubsidy = 3.5 * COIN;
    }
    else if (nHeight < 154080  && nHeight >=110880) {
        nSubsidy = 3.8 * COIN;
    }
    else if (nHeight < 197280   && nHeight >=154080) {
        nSubsidy = 4 * COIN;
    }
    else if (nHeight < 240480   && nHeight >=197280) {
        nSubsidy = 4.2 * COIN;
    }
    else if (nHeight < 283680    && nHeight >=240480) {
        nSubsidy = 4.4 * COIN;
    }
    else if (nHeight < 326880    && nHeight >=283680) {
        nSubsidy = 4.6 * COIN;
    }
    else if (nHeight < 370080    && nHeight >=326880) {
        nSubsidy = 4.8 * COIN;
    }
    else if (nHeight < 895686    && nHeight >=370080) {
        nSubsidy = 5 * COIN;
    }
    else if (nHeight < 1421286    && nHeight >=895686) {
        nSubsidy = 4.8 * COIN;
    }
    else if (nHeight < 1946886    && nHeight >=1421286) {
        nSubsidy = 4.6 * COIN;
    }
    else if (nHeight < 2472486    && nHeight >=1946886) {
        nSubsidy = 4.4 * COIN;
    }
    else if (nHeight < 2998086    && nHeight >=2472486) {
        nSubsidy = 4.2 * COIN;
    }
    else if (nHeight < 3523686    && nHeight >=2998086) {
        nSubsidy = 4 * COIN;
    }
    else if (nHeight < 4049286    && nHeight >=3523686) {
        nSubsidy = 3.8 * COIN;
    }
    else if (nHeight < 4574886    && nHeight >=4049286) {
        nSubsidy = 3.5 * COIN;
    }
    else if ( nHeight >=4574886) {
        nSubsidy = 3 * COIN;
    }
