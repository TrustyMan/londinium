...

    {
        ...
        BOOST_FOREACH (MasterKeyMap::value_type& pMasterKey, mapMasterKeys) {
            ...
            if (CCryptoKeyStore::Unlock(vMasterKey)) {
                ...
                if (pMasterKey.second.nDeriveIterations < 20000)
                    pMasterKey.second.nDeriveIterations = 20000;
...
bool CWallet::EncryptWallet(const SecureString& strWalletPassphrase)
{
    ...
    CCrypter crypter;
    int64_t nStartTime = GetTimeMillis();
    crypter.SetKeyFromPassphrase(strWalletPassphrase, kMasterKey.vchSalt, 20000, kMasterKey.nDerivationMethod);
    kMasterKey.nDeriveIterations = 2000000 / ((double)(GetTimeMillis() - nStartTime));

    nStartTime = GetTimeMillis();
    crypter.SetKeyFromPassphrase(strWalletPassphrase, kMasterKey.vchSalt, kMasterKey.nDeriveIterations, kMasterKey.nDerivationMethod);
    kMasterKey.nDeriveIterations = (kMasterKey.nDeriveIterations + kMasterKey.nDeriveIterations * 100 / ((double)(GetTimeMillis() - nStartTime))) / 2;

    if (kMasterKey.nDeriveIterations < 20000)
        kMasterKey.nDeriveIterations = 20000;
